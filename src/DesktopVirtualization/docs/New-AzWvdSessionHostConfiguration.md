...
online version: https://docs.microsoft.com/powershell/module/az.desktopvirtualization/new-azwvdsessionhostconfiguration
schema: 2.0.0
---
...
New-AzWvdSessionHostConfiguration -HostPoolName <String> -ResourceGroupName <String>
 ...
 -NetworkInfoSecurityGroupId <String> -NetworkInfoSubnetId <String>
 -VMAdminCredentialsPasswordKeyVaultSecretUri <String> -VMAdminCredentialsUsername <String>
 ...
 [-MarketplaceInfoPublisher <String>] [-MarketplaceInfoSku <String>] [-SecurityInfoSecureBootEnabled]
 [-SecurityInfoType <VirtualMachineSecurityType>] [-SecurityInfoVTpmEnabled]
 [-SupportedFirstPartyExtension <Hashtable>] [-VMLocation <String>] [-VMTag <Hashtable>]
