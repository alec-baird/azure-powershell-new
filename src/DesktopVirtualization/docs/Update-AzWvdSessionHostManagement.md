...
online version: https://docs.microsoft.com/powershell/module/az.desktopvirtualization/update-azwvdsessionhostmanagement
schema: 2.0.0
---
...
Update-AzWvdSessionHostManagement -HostPoolName <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DeployCanary] [-CanaryPolicy <CanaryPolicy>]
 [-FailedProvisioningCleanupPolicy <FailedProvisioningCleanupPolicy>] [-InstanceCount <Int32>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzWvdSessionHostManagement -InputObject <IDesktopVirtualizationIdentity> [-DeployCanary]
...
### -DeployCanary
Override parameter to force canary sessionHost to be created or not created on the provisioning request.
