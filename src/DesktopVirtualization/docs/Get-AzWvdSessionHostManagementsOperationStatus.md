...
online version: https://docs.microsoft.com/powershell/module/az.desktopvirtualization/get-azwvdsessionhostmanagementsoperationstatus
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzWvdSessionHostManagementsOperationStatus -HostPoolName <String> -OperationStatusId <String>
...
### Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.Api30.IOperationStatusResult
